module.exports = {
  ...
  moduleNameMapper: {
    ...
    '@siteed/moonshine.rn': '<rootDir>/__mocks__/external/moonshine.rn.ts',
    'react-native-live-audio-stream':
      '<rootDir>/__mocks__/external/react-native-live-audio-stream.js',
    'onnxruntime-react-native':
      '<rootDir>/__mocks__/external/onnxruntime-react-native.ts',
  },
};
