  ...
  ({onSelectModel, bottomComponentHeight}: ChatEmptyPlaceholderProps) => {
      ...
      if (pendingPalDownload) {
        return {
          ...
          description:
            ...
            'We’ll let you know the moment your agent can chat. Tap the banner up top to see how it’s going.',
          buttonText: null,
          onPress: () => {},
        };
      }
    ...
    return (
      <View
        ...
        {/* TODO: replace this placeholder with the new homepage image */}
