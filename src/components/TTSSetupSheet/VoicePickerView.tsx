...
const ENGINE_ORDER: EngineId[] = ['inflect', 'kitten', 'kokoro', 'supertonic'];
...
const engineTitle = (engineId: EngineId, l: L10n): string => {
  switch (engineId) {
    case 'inflect':
      return l.voiceAndSpeech.engineChipInflect;
    case 'kitten':
...
const engineTagline = (engineId: EngineId, l: L10n): string => {
  switch (engineId) {
    case 'inflect':
      return l.voiceAndSpeech.engineInflectTagline;
    case 'kitten':
...
const neuralStateFor = (engineId: NeuralEngineId): DownloadState => {
  switch (engineId) {
    case 'inflect':
      return ttsStore.inflectDownloadState;
    case 'kitten':
...
const neuralProgressFor = (engineId: NeuralEngineId): number => {
  switch (engineId) {
    case 'inflect':
      return ttsStore.inflectDownloadProgress;
    case 'kitten':
...
const neuralErrorFor = (engineId: NeuralEngineId): string | null => {
  switch (engineId) {
    case 'inflect':
      return ttsStore.inflectDownloadError;
    case 'kitten':
...
const triggerDownload = (engineId: NeuralEngineId) => {
  switch (engineId) {
    case 'inflect':
      return ttsStore.downloadInflect();
    case 'kitten':
...
const triggerRetry = (engineId: NeuralEngineId) => {
  switch (engineId) {
    case 'inflect':
      return ttsStore.retryInflectDownload();
    case 'kitten':
