...
export type NeuralEngineId = 'inflect' | 'supertonic' | 'kokoro' | 'kitten';
...
export class TTSStore {
  ...
  inflectDownloadState: NeuralDownloadState = 'not_installed';
  inflectDownloadProgress: number = 0;
  inflectDownloadError: string | null = null;
  ...
  async init(): Promise<void> {
    ...
    const neuralIds: NeuralEngineId[] = ['inflect', 'supertonic', 'kokoro', 'kitten'];
  ...
  private setDownloadState(id: NeuralEngineId, state: NeuralDownloadState) {
    if (id === 'supertonic') {
      ...
      this.inflectDownloadState = state;
    }
  }
  ...
  private setDownloadProgress(id: NeuralEngineId, progress: number) {
    if (id === 'supertonic') {
      ...
      this.inflectDownloadProgress = progress;
    }
  }
  ...
  private setDownloadError(id: NeuralEngineId, error: string | null) {
    if (id === 'supertonic') {
      ...
      this.inflectDownloadError = error;
    }
  }
  ...
  private getDownloadState(id: NeuralEngineId): NeuralDownloadState {
    ...
    return this.inflectDownloadState;
  }
  ...
  > = {
    ...
    inflect: INFLECT_MODEL_ESTIMATED_BYTES,
  };
  ...
  async downloadInflect(): Promise<void> {
    return this.downloadNeuralEngine('inflect');
  }
  ...
  async retryInflectDownload(): Promise<void> {
    return this.downloadNeuralEngine('inflect');
  }
  ...
  async deleteInflect(): Promise<void> {
    return this.deleteNeuralEngine('inflect');
  }
}
